...
<p align="center">
  <img src="https://img.shields.io/badge/version-1.3.0-d89a4a?style=flat-square" alt="version 1.3.0">
  <img src="https://img.shields.io/badge/license-Apache--2.0-blue?style=flat-square" alt="Apache-2.0">
  <img src="https://img.shields.io/badge/kernel-376%20KB%20%C2%B7%2032%20files-success?style=flat-square" alt="376 KB, 32 files">
  ...
  <img src="https://img.shields.io/badge/contract-108%20lines-success?style=flat-square" alt="108-line contract">
</p>
...
shasum -c loft_1.3.0.tgz.sha256        # integrity first: expect "OK"
...
- The contract, [`.claude/CLAUDE.md`](bundle/.claude/CLAUDE.md): 108 lines, ~3k
...
- Two hooks. `leak-guard` keeps values from `.secrets.env` out of documents
  (the rest of the hygiene — IPs, hosts, credentials in the clear — is on the
  agent and the "hygiene" axis in `tz-audit`), plus a silent update check.
